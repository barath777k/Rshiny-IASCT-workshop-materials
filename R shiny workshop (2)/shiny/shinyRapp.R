    ...
    sidebarPanel(width = 3,
                 ...
                 conditionalPanel(condition = "input.tabselected == 'Demographics'",
                                  ...
                                  selectInput(inputId  = "demovar",
                                              label    = "Choose demographic variable",
                 ...
                 conditionalPanel(condition = "input.tabselected == 'Adverse Events'",
                                  ...
                                  selectInput(inputId  = "aeser",
                                              label    = "Serious event",
                                              choices  = unique(adae$AESER),
                                              multiple = TRUE,
                                              selected = sort(unique(adae$AESER))
                                  ),
                 ...
                 # For Vital Signs tab
                 conditionalPanel(condition = "input.tabselected == 'Vital Signs'",
              ...
              tabsetPanel(
                ...
                tabPanel("Demographics",
                         fluidRow(
                           ...
                           column(5, plotOutput(outputId = "plot_base", height = 250)),
                         ),
                         br(),
                         fluidRow(
                ...
                tabPanel("Adverse Events",
                         ...
                         fluidRow(
                           column(10, DTOutput("dt_ae", height = 250))
                         )
                ),
